...
17. **Sidebar-top/логотипный блок на всех страницах** ✅ **ИСПРАВЛЕНО**
    ...
    - [x] 2025-11-18: Дэшборд получил новый модульный дизайн (hero, метрики, панели аналитики, карточка бюджетов)
    - [x] 2025-11-18: Страницы счетов и операций приведены к новому shell (hero, метрики, фильтры, списки)
